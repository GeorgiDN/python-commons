...
from project import excel_file
...
class RegistrationForm:
    def __init__(self, root):
        ...
        tk.Button(self.root, text='Submit', width=20, bg='brown', fg='white', command=self.insert_data).place(x=180, y=440)
    ...
    def insert_data(self):
        """
        Validate fields and insert them into the registration form.
        """
        ...
        for error_label in data_labels:
            if error_label:
                error_label.destroy()
        ...
        if is_valid:
            ...
            excel_file.add_data_to_excel(current_time, first_name, last_name, phone_number, address, my_email, my_password)
